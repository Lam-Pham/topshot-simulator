    ...
    return (
      <div class="mt-32">
        ...
        <div class="space-x-4 mt-20 2xl:mt-16 mx-52 2xl:mx-72">
          ...
          <Link href="/helpwanted"><button class="mb-72 inline-block col-start-2 col-span-1 2xl:mb-56 transform active:translate-y-1 duration-200 -mt-12 border-2 border-b-4 border-black focus:outline-none bg-white rounded-full py-2 px-8 font-bold hover:bg-gray-200 text-sm">...or contribute to become one!</button></Link>
        </div>
      </div>
    )
  }
