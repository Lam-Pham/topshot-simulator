    ...
    return (
      <div class="mt-32">
        ...
        <div class="grid grid-cols-3 gap-x-24 gap-y-16 mt-24">
                ...
                <Link href="/helpwanted"><button class="col-start-2 col-span-1 2xl:mb-56 mb-24 transform active:translate-y-1 duration-200 -mt-12 border-2 border-b-4 border-black focus:outline-none bg-white rounded-full py-2 px-8 font-bold hover:bg-yellow-300 bg-yellow-200 text-sm">better yet, contribute to become one!</button></Link>
        </div>
      </div>
    )
  }
